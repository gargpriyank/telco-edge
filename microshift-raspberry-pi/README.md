...
6. Install Microshift
   ...
   curl -L -o /etc/yum.repos.d/group_redhat-et-microshift-epel-8.repo https://copr.fedorainfracloud.org/coprs/g/redhat-et/microshift/repo/epel-8/group_redhat-et-microshift-epel-8.repo
